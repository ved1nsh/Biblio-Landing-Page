...
// The previous homepage, kept for reference. Not a route (folders starting with _ are private in Next.js).
// The live homepage is app/page.tsx, which shows the page built in app/zamp/.
...
export default function Home() {
  ...
  return (
    <div
      className="site-scale min-h-screen w-full"
