...
const notesCards = [
    {
        ...
        description:
            "Every reader is unique. Biblio gives you total control over the page, turning every ePub and PDF into a custom-tailored experience for your eyes only.",
    ...
    },
    {
        id: 2,
        kind: "image" as const,
        image: "/images/notes/notes1.png",
        caption:
            "Select from a curated library of high-legibility fonts—like Bookerly, Palatino, and Baskerville—optimized for long-form digital reading.",
        imageWrapperClass:
    ...
    },
    {
        id: 3,
        kind: "image" as const,
        image: "/images/notes/notestwo.png",
        caption:
            "Shift the mood instantly with four distinct reading modes designed for optimal reading comfort: Day, Paper, Night, and True Dark.",
        imageWrapperClass:
    ...
    },
    {
        id: 4,
        kind: "image" as const,
        image: "/images/notes/notesthree.png",
        caption:
            "Don't just read—immerse yourself. Biblio's dynamic themes adapt to the content of your page, creating a visually harmonious reading environment that enhances focus and retention.",
        imageWrapperClass:
            "pointer-events-none absolute bottom-0 left-1/2 h-[88%] w-[95%] -translate-x-1/2 sm:h-[92%] md:h-[95%]",
        imageClass: "object-contain object-bottom",
    },
...
export default function PageFourSection() {
    return (
        <section
        ...
        >
            <div className="mx-auto w-full px-6 md:px-10">
                <div className="text-center">
                    ...
                    >
                        Your Library, Your Lens.
                    </h2>
                    <p className="mt-4 text-base text-[#8a7e6b] md:text-lg">
                        Total command over the page. Designed by you, for you.
                    </p>
                </div>
                                        ...
                                        <>
                                            <div className="relative flex-1 overflow-hidden">
                                                <div className={card.imageWrapperClass}>
                                                    <Image
                                                        src={card.image}
                                                        alt={card.caption || "Feature screenshot"}
                                                        fill
