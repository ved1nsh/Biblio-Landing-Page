            ...
            >
                <div className="mx-auto w-full max-w-[1360px]">
                    <div className="flex flex-col text-left">
                        <h2
                            className="bg-gradient-to-r from-[#000000] via-[#000000] to-[#000000] bg-clip-text pb-2 text-[36px] font-normal leading-[1.1] tracking-[-0.04em] text-transparent md:pb-4 md:text-[88px] md:leading-[1.05]"
