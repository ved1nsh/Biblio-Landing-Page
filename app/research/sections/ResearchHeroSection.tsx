        ...
        <section className="relative w-full overflow-hidden">
            ...
            <div className="relative w-full px-6 py-20 md:px-10 md:py-32">
                <div className="mx-auto flex w-full max-w-[1240px] flex-col items-center text-center">
                    ...
                    <h1
                        className="mb-6 text-[36px] font-normal leading-[1.15] text-white md:mb-10 md:text-[88px] md:leading-[1.1]"
                        style={{ fontFamily: "var(--font-stack-sans)" }}
                    >
                        Market Research
                    </h1>

                    <p className="mb-8 max-w-300 text-[16px] leading-[1.4] text-zinc-200 md:text-[26px]">
