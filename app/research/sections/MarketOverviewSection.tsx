    ...
    return (
        <section className="w-full bg-[#F2EFE7] px-6 py-8 text-black md:px-10 md:py-16">
            <div className="mx-auto w-full max-w-[1360px]">
                <h2
                    className="max-w-[920px] text-[44px] font-normal leading-[0.95] tracking-[-0.04em] text-black md:text-[88px]"
                ...
                <div className="mt-16 md:mt-20">
                    <h3
                        className="text-[32px] font-normal leading-none tracking-tight text-black md:text-[56px]"
                        style={{ fontFamily: "var(--font-stack-sans)" }}
                    >
                        Market Size & Opportunity
                    </h3>

                    <p className="mt-10 max-w-[1500px] space-y-8 text-[18px] leading-[1.25] text-zinc-900 md:mt-12 md:space-y-10 md:text-[26px]">
                    ...
                    <div className="mt-10 grid gap-8 md:mt-12 md:grid-cols-2 md:gap-10">
                        <article className="rounded-[36px] bg-black px-8 py-10 text-left text-white md:px-14 md:py-14">
                            <h4
                                className="bg-gradient-to-b from-[#8A8DFF] to-[#5F63FF] bg-clip-text text-[60px] font-medium leading-none tracking-tight text-transparent md:text-[88px]"
                                style={{ fontFamily: "var(--font-stack-sans)" }}
                            >
                                40 Million +
                            </h4>

                            <p className="mt-8 max-w-[420px] text-[18px] leading-[1.22] text-zinc-400 md:text-[25px]">
                        ...
                        <article className="rounded-[36px] bg-black px-8 py-10 text-left text-white md:px-14 md:py-14">
                            ...
                            <p className="mt-8 max-w-[440px] text-[18px] leading-[1.22] text-zinc-400 md:text-[25px]">
